...
**Status:** Wave 1 exited **2026-08-10** ([WAVE-1-EXIT.md](./WAVE-1-EXIT.md)). W1.6 mobile shipped. **Next:** W1.5 closeout (show-completed, calendar drag, epic aggregate) → Google Calendar → Scheduler ([07-wave-roadmap.md](./07-wave-roadmap.md)).
