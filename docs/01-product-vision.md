...
**Status:** Wave 1 exited **2026-08-10** ([WAVE-1-EXIT.md](./WAVE-1-EXIT.md)). Wave 1.5 largely shipped; **Wave 1.6** mobile polish shipped. **Next:** Wave 2 scheduler ([07-wave-roadmap.md](./07-wave-roadmap.md)).
