...
**Status:** Wave 1 exited **2026-08-10** ([WAVE-1-EXIT.md](./WAVE-1-EXIT.md)). W1.5 closeout + W1.6 mobile shipped. **Next:** Google Calendar → Scheduler ([07-wave-roadmap.md](./07-wave-roadmap.md)).
